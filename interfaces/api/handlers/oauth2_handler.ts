...
import { CognitoOAuth2Provider } from '../../../core/services/auth/providers/cognito.ts';
import { decodeBase64 } from '@std/encoding/base64';
import { GRANT_TYPES, UnauthorizedError } from '../../../core/services/auth/auth.ts';
...
const provider = new CognitoOAuth2Provider({
